    ...
    <details className={styles.accordion}>
      <summary className={styles.question}>
        <div className={styles.q_sentence}>
          <span className={styles.capital}>Q&#46;</span>
          <span className={styles.q_content}>{question}</span>
        </div>
        <Image src="/openBtn.png" alt="" className={styles.icon} width={25} height={27} />
      </summary>
      <div className={styles.answer}>
        <div className={styles.a_sentence}>
          <span className={styles.capital}>A&#46;</span>
          <span className={styles.a_content}>{answer}</span>
        </div>
      </div>
    </details>
  );
